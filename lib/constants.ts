...
export const DRIVER_TESTIMONIALS = [
  ...
  {
    name: "Mikaela Humphries",
    username: "@mikaelah",
    text: "Joined after referral, stayed for the culture. Safety team actually acts on driver feedback — that almost never happens.",
    color: "#EC4899",
  },
  {
    name: "Loren Doherty",
